"""
This module computes inverse kinematic and differential inverse kinematic values for joints based
on end effectors
## There are many libraries for this task, find and use them
## EVEN mujoco has some tools
"""
    ...
    for steps in range(max_steps):
        ...
        if err_norm < tol:
            ...
            if progress_criterion > progress_thresh:
                logging.debug("Step %2i: err_norm / update_norm (%3g) > " "tolerance (%3g). Halting due to insufficient progress", steps, progress_criterion, progress_thresh)
                break
